...
*/
var aa=__webpack_require__(0),n=__webpack_require__(5),r=__webpack_require__(12);function t(a){for(var b=a.message,c="https://reactjs.org/docs/error-decoder.html?invariant="+b,d=1;d<arguments.length;d++)c+="&args[]="+encodeURIComponent(arguments[d]);a.message="Minified React error #"+b+"; visit "+c+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ";return a}if(!aa)throw t(Error(227));var ba=null,ca={};
...
function esm_onlyChild(children) {
...
function createReactContext(defaultValue, calculateChangedBits) {
  ...
  function (_Component2) {
    ...
    _proto2.render = function render() {
      return esm_onlyChild(this.props.children)(this.state.value);
    };
...
var FetchContainer_FetchContainer =
/*#__PURE__*/
function (_React$Component) {
  ...
  function FetchContainer(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FetchContainer).call(this, props));
    _this.state = {
      err: null,
      fetchResults: null
    };
  ...
  _createClass(FetchContainer, [{
    ...
    value: function renderError(err) {
      ...
      }, react_default.a.createElement("strong", null, "Oh sorrow!"), " ", err.toString());
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return react_default.a.cloneElement(onlyChild, this.state.fetchResults);
    }
  }]);
...
function Balances_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Balances_typeof = function _typeof(obj) { return typeof obj; }; } else { Balances_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Balances_typeof(obj); }
...
function (_React$Component) {
  ...
  function Balances() {
    ...
    return Balances_possibleConstructorReturn(this, Balances_getPrototypeOf(Balances).apply(this, arguments));
  }
  ...
  Balances_createClass(Balances, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        className: "m-3"
      }, react_default.a.createElement(util_FetchContainer, {
        fetch: {
      ...
      }, react_default.a.createElement(Balances_BalancesView, null)));
    }
  }]);
...
function (_React$Component2) {
  ...
  function BalancesView(props) {
    ...
    return Balances_possibleConstructorReturn(this, Balances_getPrototypeOf(BalancesView).call(this, props));
  }
  ...
  Balances_createClass(BalancesView, [{
    ...
    value: function renderListGroup(accountTypeCode) {
      ...
      }, react_default.a.createElement("div", null, accountType.accountTypeCode + " - " + accountType.accountTypeName), react_default.a.createElement("div", null, react_default.a.createElement("small", null, accounts.length, " account", accounts.length == 1 ? "" : "s")))), react_default.a.createElement("ul", {
    ...
    value: function renderListGroupItem(account) {
      ...
      }, account.accountCode + " - " + account.accountName), react_default.a.createElement(Balances_BalanceRow, {
        accountBalance: balancePrev,
        sign: accountType.sign
      }), react_default.a.createElement(Balances_BalanceRow, {
    ...
    key: "render",
    value: function render() {
      return react_default.a.createElement("div", null, this.renderListGroup("A"), this.renderListGroup("L"), react_default.a.createElement("p", null, this.props.accountTypes.map(function (accountType) {
        return react_default.a.createElement("div", null, JSON.stringify(accountType));
      })), react_default.a.createElement("p", null, JSON.stringify(this.props.accountBalances)), react_default.a.createElement("p", null, JSON.stringify(this.props.accounts)));
    }
  }]);
...
function (_React$Component3) {
  ...
  function BalanceRow(props) {
    ...
    _this3 = Balances_possibleConstructorReturn(this, Balances_getPrototypeOf(BalanceRow).call(this, props));
    _this3.state = {
      loading: false,
      error: null
    };
  ...
  Balances_createClass(BalanceRow, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        ...
        className: "col"
      }, formatDateLong(accountBalance.postingDate), Number.isInteger(postingCount) && react_default.a.createElement("span", null, " ", mdash, " ", react_default.a.createElement("span", {
        className: "text-primary"
      }, postingCount, " new posting", postingCount > 1 && "s"))), react_default.a.createElement("div", {
        className: "col-auto"
      }, react_default.a.createElement("span", {
        className: accountBalance.amount * sign < 0 ? " text-danger" : ""
      }, formatAmount(accountBalance.amount * sign))), react_default.a.createElement("div", {
    ...
    value: function render() {
      if (this.state.err) {
        ...
        return react_default.a.createElement("div", {
          ...
          className: "alert alert-danger"
        }, react_default.a.createElement("strong", null, "Oh sorrow!"), " ", this.state.err.toString()));
      }
...
function (_React$Component) {
  ...
  function AccountInput(props) {
    ...
    _this = AccountInput_possibleConstructorReturn(this, AccountInput_getPrototypeOf(AccountInput).call(this, props));
    _this.state = {
      text: "",
      show: false
    };
    ...
    _this.dropdownMenuRef = react_default.a.createRef();
    return _this;
  }
  ...
  AccountInput_createClass(AccountInput, [{
    ...
    value: function renderDropdownMenuChildren() {
      ...
      return accountTypes.map(function (accountType) {
        return react_default.a.createElement(react_default.a.Fragment, {
          key: accountType.accountTypeId
        }, accountType !== accountTypes[0] && react_default.a.createElement("div", {
          className: "dropdown-divider"
        }), react_default.a.createElement("h6", {
          className: "dropdown-header"
        }, accountType.accountTypeCode + " - " + accountType.accountTypeName, accounts !== _this4.props.accounts && react_default.a.createElement("small", {
    ...
    value: function renderLabel(label) {
      ...
      if (this.state.text && i >= 0) {
        return react_default.a.createElement("span", null, label.substring(0, i), react_default.a.createElement("span", {
          className: "bg-warning"
        }, label.substring(i, i + this.state.text.length)), label.substring(i + this.state.text.length));
      } else {
        return react_default.a.createElement("span", null, label);
      }
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return react_default.a.createElement(react_default.a.Fragment, null, this.renderDropdownMenu(), react_default.a.cloneElement(inputElement, {
...
function (_React$Component) {
  ...
  function DatePicker(props) {
    ...
    _this = DatePicker_possibleConstructorReturn(this, DatePicker_getPrototypeOf(DatePicker).call(this, props));
  ...
  DatePicker_createClass(DatePicker, [{
    ...
    value: function renderDropdownMenu() {
      ...
      return react_default.a.createElement("div", {
      ...
      }, this.state.firstDate.format("MMMM YYYY"))), react_default.a.createElement("div", {
        className: "d-flex"
        ...
        }, react_default.a.createElement("small", null, m.format("dd")));
    ...
    value: function render() {
      var inputElement = react_default.a.Children.only(this.props.children);
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.cloneElement(inputElement, {
...
function (_React$Component) {
  ...
  function Post(props) {
    ...
    _this = Post_possibleConstructorReturn(this, Post_getPrototypeOf(Post).call(this, props));
  ...
  Post_createClass(Post, [{
    ...
    value: function render() {
      return react_default.a.createElement("form", {
      ...
      }, react_default.a.createElement(util_DatePicker, {
        ...
        return react_default.a.createElement("option", null, c.currencyCode);
      })), react_default.a.createElement("input", {
        type: "text",
      ...
      }, "From:")), react_default.a.createElement(util_AccountInput, {
        accountTypes: this.props.accountTypes,
        accounts: this.props.accounts,
        key: this.state.resetCount,
        ...
        className: "input-group-text"
      }, "To:")), react_default.a.createElement(util_AccountInput, {
        accountTypes: this.props.accountTypes,
        accounts: this.props.accounts,
        key: this.state.resetCount,
      ...
      }, "Post")), react_default.a.createElement("div", {
        className: "col-auto"
      }, react_default.a.createElement("button", {
        type: "reset",
        ...
        className: "col ml-2"
      }, this.state.running ? react_default.a.createElement("div", {
        className: "spinner-grow spinner-grow-sm text-primary",
        role: "status"
      }, react_default.a.createElement("span", {
        className: "sr-only"
      }, "Loading...")) : this.state.message && !(this.state.message instanceof Error) && react_default.a.createElement("div", {
        className: "text-success"
      }, this.state.message))), react_default.a.createElement("div", {
        className: "mb-2"
      }, !this.state.running && this.state.message instanceof Error && react_default.a.createElement("div", {
        className: "alert alert-danger alert-dismissible",
        role: "alert"
      }, this.state.message.message, react_default.a.createElement("button", {
        type: "button",
        className: "close",
        "data-dismiss": "alert",
        "aria-label": "Close",
...
function Upload() {
  ...
  return react_default.a.createElement("div", {
    ...
    htmlFor: "customFile"
  }, "Choose file")), react_default.a.createElement("button", {
    type: "submit",
...
function Postings_toConsumableArray(arr) { return Postings_arrayWithoutHoles(arr) || Postings_iterableToArray(arr) || Postings_nonIterableSpread(); }

function Postings_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance"); }

function Postings_iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === "[object Arguments]") return Array.from(iter); }

function Postings_arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }

function Postings_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Postings_typeof = function _typeof(obj) { return typeof obj; }; } else { Postings_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Postings_typeof(obj); }
...
var Postings_Postings = function Postings() {
  return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(react_router_Route, {
    exact: true,
    path: "/postings",
...
var Postings_PostingsIndex = function PostingsIndex() {
  ...
  }, "zzz"), react_default.a.createElement("div", {
  ...
  }, react_default.a.createElement(src_Post, null)))), react_default.a.createElement("div", {
    className: "row"
  }, react_default.a.createElement("div", {
    className: "col mb-3"
  }, react_default.a.createElement("hr", null), react_default.a.createElement(Postings_PostingsListing, null))));
};

var Postings_PostingsListing =
/*#__PURE__*/
function (_React$Component) {
  ...
  function PostingsListing(props) {
    ...
    _this = Postings_possibleConstructorReturn(this, Postings_getPrototypeOf(PostingsListing).call(this, props));
    _this.state = {
      input: {
        month: 0,
        year: 0
  ...
  Postings_createClass(PostingsListing, [{
    ...
    value: function render() {
      return react_default.a.createElement("div", null, react_default.a.createElement("form", {
        ...
        value: "0",
        selected: true
      }, "Month"), react_default.a.createElement("option", {
        value: "1"
      }, "January"), react_default.a.createElement("option", {
        value: "2"
      }, "February"), react_default.a.createElement("option", {
        value: "3"
      }, "March"), react_default.a.createElement("option", {
        value: "4"
      }, "April"), react_default.a.createElement("option", {
        value: "5"
      }, "May"), react_default.a.createElement("option", {
        value: "6"
      }, "June"), react_default.a.createElement("option", {
        value: "7"
      }, "July"), react_default.a.createElement("option", {
        value: "8"
      }, "August"), react_default.a.createElement("option", {
        value: "9"
      }, "September"), react_default.a.createElement("option", {
        value: "10"
      }, "October"), react_default.a.createElement("option", {
        value: "11"
      }, "November"), react_default.a.createElement("option", {
        value: "12"
      }, "December")), react_default.a.createElement("select", {
        className: "custom-select",
        id: "yearInput",
        ...
        value: "0",
        selected: true
      }, "Year"), react_default.a.createElement("option", null, "2018"), react_default.a.createElement("option", null, "2019")), react_default.a.createElement("div", {
        className: "input-group-append"
      }, react_default.a.createElement("button", {
        type: "submit",
        className: "btn btn-outline-primary",
        disabled: !this.state.input.month || !this.state.input.year
      }, "View")))), react_default.a.createElement("div", {
        className: "col-auto my-1"
      }, react_default.a.createElement("div", {
        className: "btn-group"
      }, react_default.a.createElement("button", {
      ...
      }, "14 days"), react_default.a.createElement("button", {
        type: "button",
        className: "btn btn-outline-primary",
        onClick: this.handleClick.bind(this, 30)
      }, "30 days"))))), react_default.a.createElement(util_FetchContainer, {
      ...
      }, react_default.a.createElement(Postings_PostingsListingResults, {
        top: this.state.top
      })));
    }
  }]);
...
var Postings_PostingsListingResults =
/*#__PURE__*/
function (_React$Component2) {
  ...
  function PostingsListingResults(props) {
    ...
    return Postings_possibleConstructorReturn(this, Postings_getPrototypeOf(PostingsListingResults).call(this, props));
  }
  ...
  Postings_createClass(PostingsListingResults, [{
    ...
    value: function renderPostingsGroup(postingDate, postingsGroup) {
      ...
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement("h6", {
        className: "mt-4"
      }, formatDateLong(postingDate)), react_default.a.createElement("div", {
        ...
        return react_default.a.createElement("div", {
        ...
        }, formatDateShort(posting.postingDate)), react_default.a.createElement("div", {
          ...
          }, formatAmount(pd.amount)), react_default.a.createElement("div", {
            className: "col-sm text-nowrap"
          }, _this2.props.accounts.find(function (a) {
            return a.accountId === pd.accountId;
          }).accountName), react_default.a.createElement("div", {
    ...
    value: function render() {
      ...
      }, react_default.a.createElement("p", null, "Found ", postings.length, " posting", postings.length == 1 ? "" : "s", " in ", this.props.top.days ? "the past " + this.props.top.days + " days" : "month " + this.props.top.month + " year " + this.props.top.year, "."), Array.from(postingsGroups.entries()).map(function (_ref) {
...
function AccountSelect_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { AccountSelect_typeof = function _typeof(obj) { return typeof obj; }; } else { AccountSelect_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return AccountSelect_typeof(obj); }

function AccountSelect_toConsumableArray(arr) { return AccountSelect_arrayWithoutHoles(arr) || AccountSelect_iterableToArray(arr) || AccountSelect_nonIterableSpread(); }

function AccountSelect_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance"); }

function AccountSelect_iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === "[object Arguments]") return Array.from(iter); }

function AccountSelect_arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }
...
var AccountSelect_AccountSelect =
/*#__PURE__*/
function (_React$Component) {
  ...
  function AccountSelect(props) {
    ...
    return AccountSelect_possibleConstructorReturn(this, AccountSelect_getPrototypeOf(AccountSelect).call(this, props));
  }
    ...
    value: function render() {
      ...
      if (this.props.accountTypes && this.props.accounts) {
        options.push(this.props.accountTypes.filter(function (accountType) {
          ...
          return react_default.a.createElement("optgroup", {
            key: accountType.accountTypeId,
        ...
        options.push(react_default.a.createElement("optgroup", {
          disabled: true,
          label: "Loading...",
      ...
      return react_default.a.cloneElement.apply(react_default.a, [selectComponent, selectComponent.props].concat(AccountSelect_toConsumableArray(options)));
    }
  }]);
...
var AccountTypeSelect_AccountTypeSelect = function AccountTypeSelect(_ref) {
  ...
  var options = [react_default.a.createElement("option", {
    value: "",
    hidden: true
  }, "Choose account type...")];
  ...
  return react_default.a.cloneElement.apply(react_default.a, [selectComponent, selectComponent.props].concat(options));
};
...
var DocumentTitle_DocumentTitle =
/*#__PURE__*/
function (_React$Component) {
...
function Accounts_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Accounts_typeof = function _typeof(obj) { return typeof obj; }; } else { Accounts_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Accounts_typeof(obj); }
...
var Accounts_Accounts = function Accounts() {
  ...
  }, react_default.a.createElement(Accounts_AccountsMain, null)));
};

var Accounts_AccountsMain =
/*#__PURE__*/
function (_React$Component) {
  ...
  function AccountsMain(props) {
    ...
    _this = Accounts_possibleConstructorReturn(this, Accounts_getPrototypeOf(AccountsMain).call(this, props));
    _this.state = {
      accounts: props.accounts.slice(0) // shallow copy

    };
    _this.accountCreateModalRef = react_default.a.createRef();
  ...
  Accounts_createClass(AccountsMain, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement(util_DocumentTitle, {
        title: "Accounts"
      }, react_default.a.createElement("div", {
      ...
      }), " Create Account"), react_default.a.createElement(Accounts_AccountCreateModal, {
        accountTypes: this.props.accountTypes,
...
var Accounts_AccountCreateModal =
/*#__PURE__*/
function (_React$Component2) {
  ...
  function AccountCreateModal(props) {
    ...
    _this5 = Accounts_possibleConstructorReturn(this, Accounts_getPrototypeOf(AccountCreateModal).call(this, props));
    _this5.state = {
      disabled: false,
      err: null,
      message: null,
    ...
    _this5.modalRef = react_default.a.createRef();
  ...
  Accounts_createClass(AccountCreateModal, [{
    ...
    value: function render() {
      ...
      }, "Create Account"), react_default.a.createElement("button", {
        type: "button",
        className: "close",
        "data-dismiss": "modal",
        "aria-label": "Close"
      ...
      }, "Account Type"), react_default.a.createElement(util_AccountTypeSelect, {
        accountTypes: this.props.accountTypes
      }, react_default.a.createElement("select", this.getFormControlProps('accountType')))), react_default.a.createElement("div", {
        className: "form-group col-lg-8"
      }, react_default.a.createElement("label", {
        htmlFor: "parentAccountInput"
      }, "Parent Account"), react_default.a.createElement(util_AccountSelect, {
        accountTypes: this.props.accountTypes,
        accounts: this.props.accounts.filter(function (a) {
          return a.accountTypeId == _this8.state.input.accountType;
        }),
        activeOnly: true
      }, react_default.a.createElement("select", Accounts_extends({
        disabled: !this.state.input.accountType
      }, this.getFormControlProps('parentAccount')), react_default.a.createElement("option", {
        value: ""
      }, "None"))))), react_default.a.createElement("div", {
        className: "form-group"
      }, react_default.a.createElement("label", {
        htmlFor: "accountCodeInput"
      }, "Short Code"), react_default.a.createElement("input", Accounts_extends({
        type: "text",
        placeholder: "Short Code"
      }, this.getFormControlProps('accountCode')))), react_default.a.createElement("div", {
        className: "form-group"
      }, react_default.a.createElement("label", {
        htmlFor: "accountNameInput"
      }, "Long Name"), react_default.a.createElement("input", Accounts_extends({
        type: "text",
        placeholder: "Long Name"
      }, this.getFormControlProps('accountName')))), this.renderAlert()), react_default.a.createElement("div", {
...
function (_React$Component) {
  ...
  Users_createClass(Users, [{
    ...
    value: function render() {
      return react_default.a.createElement(util_DocumentTitle, {
        title: "Users"
      }, react_default.a.createElement("div", null, "Users"));
    }
  }]);
...
var Settings_Settings = function Settings() {
  return react_default.a.createElement("div", null, react_default.a.createElement(react_router_Route, {
    exact: true,
    path: "/settings",
...
var Settings_SettingsIndex = function SettingsIndex() {
  return react_default.a.createElement("div", {
    ...
    className: "nav-link"
  }, "Accounts")), react_default.a.createElement("li", {
    className: "nav-item"
  }, react_default.a.createElement(Link, {
    to: "/settings/users",
    className: "nav-link"
...
function (_React$Component) {
  ...
  Sidebar_createClass(Sidebar, [{
    ...
    value: function render() {
      ...
      }, this.renderMenuItem(1, "pages", "fa-book"), this.renderMenuItem(2, "settings", "fa-cog"))), react_default.a.createElement("div", {
      ...
      }, "Pages"), react_default.a.createElement("nav", {
        className: "oasisledger-sidebar__nav"
      }, react_default.a.createElement("ul", {
        className: "nav flex-column"
      }, this.renderNavItem("/postings", "Postings"), this.renderNavItem("/balances", "Balances")))), react_default.a.createElement("div", {
        className: "oasisledger-sidebar__tab"
      }, react_default.a.createElement("div", {
        className: "oasisledger-sidebar__heading"
      }, "Settings"), react_default.a.createElement("nav", {
        className: "oasisledger-sidebar__nav"
      }, react_default.a.createElement("ul", {
        className: "nav flex-column"
...
function (_React$Component) {
  ...
  App_createClass(App, [{
    ...
    value: function render() {
      ...
      }, "Oasis Ledger")), react_default.a.createElement("div", {
      ...
      }, "Oasis Ledger"))), react_default.a.createElement(react_router_dom_HashRouter, null, react_default.a.createElement("div", {
        className: "oasisledger-content" + (this.state.showMobileSidebar ? " oasisledger-content--show-mobile-sidebar" : "")
      }, react_default.a.createElement(react_router_Route, {
        path: "/",
        render: function render(routeProps) {
          return react_default.a.createElement(src_Sidebar, App_extends({}, routeProps, {
      ...
      }, react_default.a.createElement(src_ErrorBoundary, null, react_default.a.createElement(react_router_Switch, null, react_default.a.createElement(Redirect, {
        exact: true,
        from: "/",
        to: "/postings"
      }), react_default.a.createElement(react_router_Route, {
...
react_dom_default.a.render(react_default.a.createElement(react_router_dom_HashRouter, null, react_default.a.createElement(src_App, null)), document.getElementById('app'));
